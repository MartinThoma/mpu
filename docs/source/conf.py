...
latex_documents = [
    (master_doc, 'mpu.tex', u'mpu Documentation',
...
man_pages = [
    (master_doc, 'mpu', u'mpu Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'mpu', u'mpu Documentation',
     author, 'mpu', 'One line description of project.',
     'Miscellaneous'),
]
